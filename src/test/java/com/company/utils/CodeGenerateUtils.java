...
public class CodeGenerateUtils {
	...
	public void generateControllerImplFile(List<Column> columns, GeneratorProperties gp) throws Exception {
		...
		final String path = gp.getProjectPath() + gp.getJavaPath() +
				packageConvertPath(gp.getBasePackage() + "." + gp.getControllerPackage()+"Impl") + gp.getDoNameUpperCamel() + suffix;
	...
	public void generateServiceImplFile(List<Column> columns, GeneratorProperties gp) throws Exception {
		final String suffix = "ServiceImpl.java";
		final String path = gp.getProjectPath() + gp.getJavaPath() +
				packageConvertPath(gp.getBasePackage() + "." + gp.getServicePackage()+"Impl") + gp.getDoNameUpperCamel() + suffix;
