...
* @date ${date}
*/
@ApiModel(value = "${tableComment}",description = "")
public class ${doNameUpperCamel}DTO {
...
<#if columns?exists>
    ...
    @ApiModelProperty(notes = "${model.columnComment!}")
        ...
        private LocalDateTime ${model.doField?uncap_first};
...
<#if columns?exists>
    <#list columns as model>
        ...
        public LocalDateTime get${model.doField}() {
        return this.${model.doField?uncap_first};
        }

        public void set${model.doField}(LocalDateTime ${model.doField?uncap_first}) {
        this.${model.doField?uncap_first} = ${model.doField?uncap_first};
        }
